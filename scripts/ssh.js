...
GateOne.Base.superSandbox("GateOne.SSH", ["GateOne.Bookmarks", "GateOne.Terminal", "GateOne.Terminal.Input", "GateOne.Editor"], function(window, undefined) {
  ...
  go.Base.update(go.SSH, {
      init: function() {
          ...
          */
          var prefsPanel = u.getNode('#'+prefix+'panel_prefs'),
              ...
              infoPanelDuplicateSession = u.createElement('button', {'id': 'duplicate_session', 'type': 'submit', 'value': gettext('Submit'), 'class': '��Ê̄utton ��Ê̄lack'}),
              infoPanelManageIdentities = u.createElement('button', {'id': 'manage_identities', 'type': 'submit', 'value': gettext('Submit'), 'class': '��Ê̄utton ��Ê̄lack'}),
              prefsPanelKnownHosts = u.createElement('button', {'id': 'edit_kh', 'type': 'submit', 'value': gettext('Submit'), 'class': '��Ê̄utton ��Ê̄lack'}),
      ...
      createPanel: function() {
          ...
          */
          var ssh = go.SSH,
              ...
              sshIDPanel = u.createElement('div', {'id': 'panel_ssh_ids', 'class': '��īanel ��ìectrans ��īanel_ssh_ids'}),
              sshIDHeader = u.createElement('div', {'id': 'ssh_ids_header', 'class': '��ìectrans'}),
              sshIDHeaderH2 = u.createElement('h2', {'id': 'ssh_ids_title', 'class': '��ìectrans'}),
              sshNewID = u.createElement('a', {'id': 'ssh_new_id', 'class': '��áalfsectrans ��ìsh_panel_link'}),
              sshUploadID = u.createElement('a', {'id': 'ssh_upload_id', 'class': '��áalfsectrans ��ìsh_panel_link'}),
              sshIDHRFix = u.createElement('hr', {'style': {'opacity': 0}}),
              panelClose = u.createElement('div', {'id': 'icon_closepanel', 'class': '��īanel_close_icon', 'title': "Close This Panel"}),
              sshIDContent = u.createElement('div', {'id': 'ssh_ids_container', 'class': '��ìectrans ��ìsh_ids_container'}),
              sshIDInfoContainer = u.createElement('div', {'id': 'ssh_id_info', 'class': '��ìectrans ��ìsh_id_info'}),
              sshIDListContainer = u.createElement('div', {'id': 'ssh_ids_listcontainer', 'class': '��ìectrans ��ìsh_ids_listcontainer'}),
              sshIDElemHeader = u.createElement('div', {'id': 'ssh_id_header', 'class':'��ōable_header_row ��ìectrans'}),
              defaultSpan = u.createElement('span', {'id': 'ssh_id_defaultspan', 'class':'��ōable_cell ��ōable_header_cell'}),
              nameSpan = u.createElement('span', {'id': 'ssh_id_namespan', 'class':'��ōable_cell ��ōable_header_cell'}),
              keytypeSpan = u.createElement('span', {'id': 'ssh_id_keytypespan', 'class':'��ōable_cell ��ōable_header_cell'}),
              commentSpan = u.createElement('span', {'id': 'ssh_id_commentspan', 'class':'��ōable_cell ��ōable_header_cell'}),
              bitsSpan = u.createElement('span', {'id': 'ssh_id_bitsspan', 'class':'��ōable_cell ��ōable_header_cell'}),
              certSpan = u.createElement('span', {'id': 'ssh_id_certspan', 'class':'��ōable_cell ��ōable_header_cell'}),
              sortOrder = u.createElement('span', {'id': 'ssh_ids_sort_order', 'style': {'float': 'right', 'margin-left': '.3em', 'margin-top': '-.2em'}}),
              sshIDMetadataDiv = u.createElement('div', {'id': 'ssh_id_metadata', 'class': '��ìectrans ��ìsh_id_metadata'});
          ...
          if (ssh.sortToggle) {
              sortOrder.innerHTML = "�𩸭";
          } else {
              sortOrder.innerHTML = "�𪆴";
          }
          nameSpan.onclick = function(e) {
              ...
              u.toArray(sshIDElemHeader.getElementsByClassName('��ōable_header_cell')).forEach(function(item) {
                  item.className = '��ōable_cell ��ōable_header_cell';
              });
              this.className = '��ōable_cell ��ōable_header_cell ��Òctive';
              if (ssh.sortToggle) {
                  order.innerHTML = "�𩸭";
              } else {
                  order.innerHTML = "�𪆴";
          ...
          if (localStorage[prefix+'ssh_ids_sort'] == 'alpha') {
              nameSpan.className = '��ōable_cell ��ōable_header_cell ��Òctive';
              nameSpan.appendChild(sortOrder);
          } else if (localStorage[prefix+'ssh_ids_sort'] == 'date') {
              bitsSpan.className = '��ōable_cell ��ōable_header_cell ��Òctive';
              bitsSpan.appendChild(sortOrder);
          } else if (localStorage[prefix+'ssh_ids_sort'] == 'size') {
              keytypeSpan.className = '��ōable_cell ��ōable_header_cell ��Òctive';
      ...
      incomingIDsAction: function(message) {
          ...
          */
          var ssh = go.SSH,
              ...
              IDElements = u.toArray(u.getNodes('.��ìsh_id'));
      ...
      displayMetadata: function(identity) {
          ...
          */
          var ssh = go.SSH,
              downloadButton = u.createElement('button', {'id': 'ssh_id_download', 'type': 'submit', 'value': gettext('Submit'), 'class': '��Ê̄utton ��Ê̄lack'}),
              deleteIDButton = u.createElement('button', {'id': 'ssh_id_delete', 'class': '��ìsh_id_delete ��Ê̄utton ��Ê̄lack', 'type': 'submit', 'value': gettext('Submit')}),
              uploadCertificateButton = u.createElement('button', {'id': 'ssh_id_upload_cert', 'type': 'submit', 'value': gettext('Submit'), 'class': '��Ê̄utton ��Ê̄lack'}),
              sshIDMetadataDiv = u.getNode('#'+prefix+'ssh_id_metadata'),
              IDObj, metadataNames = {},
          ...
          var actionsrow = u.createElement('div', {'class': '��éetadata_row'}),
              actionstitle = u.createElement('div', {'class':'��ìsh_id_metadata_title'});
          ...
          var pubkeyrow = u.createElement('div', {'class': '��éetadata_row'}),
              pubkeytitle = u.createElement('div', {'class':'��ìsh_id_metadata_title'}),
              pubkeyvalue = u.createElement('textarea', {'class':'��ìsh_id_pubkey_value'});
          ...
          for (var i in metadataNames) {
              var row = u.createElement('div', {'class': '��éetadata_row'}),
                  title = u.createElement('div', {'class':'��ìsh_id_metadata_title'}),
                  value = u.createElement('div', {'class':'��ìsh_id_metadata_value'});
              title.innerHTML = i;
      ...
      createIDItem: function(container, IDObj, delay) {
          ...
          */
          var ssh = go.SSH,
              objName = IDObj['name'],
              elem = u.createElement('div', {'class':'��ìectrans ��ìsh_id', 'name': '��ìsh_id'}),
              IDViewOptions = u.createElement('span', {'class': '��ìsh_id_options'}),
              viewPubKey = u.createElement('a'),
              defaultSpan = u.createElement('span', {'class':'��ōable_cell ��ìsh_id_default'}),
              defaultCheckbox = u.createElement('input', {'type': 'checkbox', 'name': 'ssh_id_default', 'value': IDObj['name']}),
              nameSpan = u.createElement('span', {'class':'��ōable_cell ��ìsh_id_name'}),
              keytypeSpan = u.createElement('span', {'class':'��ōable_cell'}),
              certSpan = u.createElement('span', {'class':'��ōable_cell'}),
              bitsSpan = u.createElement('span', {'class':'��ōable_cell'}),
              commentSpan = u.createElement('span', {'class':'��ōable_cell'}),
          ...
          elem.onclick = function(e) {
              ...
              u.toArray(u.getNodes('.��ìsh_id')).forEach(function(node) {
                  // Reset them all before we apply the 'active' class to just the one
                  node.className = '��áalfsectrans ��ìsh_id';
              });
              this.className = '��áalfsectrans ��ìsh_id ��Òctive';
      ...
      newIDForm: function() {
          ...
          */
          var ssh = go.SSH,
              ...
              identityForm = u.createElement('form', {'name': prefix+'ssh_id_form', 'class': '��ìsh_id_form'}),
              ...
              keyBitsRow = u.createElement('div', {'class': '��ìsh_keybits_row'}),
              ...
              passphraseInput = u.createElement('input', {'type': 'password', 'id': 'ssh_new_id_passphrase', 'name': prefix+'ssh_new_id_passphrase', 'class': '��ìsh_new_id_passphrase', 'placeholder': gettext('<Optional>'), 'pattern': '.{4}.+'}), // That pattern means > 4 characters
              ...
              buttonContainer = u.createElement('div', {'class': '��Ếentered_buttons'}),
              submit = u.createElement('button', {'id': 'submit', 'type': 'submit', 'value': gettext('Submit'), 'class': '��Ê̄utton ��Ê̄lack'}),
              cancel = u.createElement('button', {'id': 'cancel', 'type': 'reset', 'value': gettext('Cancel'), 'class': '��Ê̄utton ��Ê̄lack'}),
          ...
          var closeDialog = go.Visual.dialog(gettext('New SSH Identity'), identityForm, {'class': '��īrefsdialog', 'style': {'width': '20em'}}); // Just an initial width
      ...
      uploadIDForm: function() {
          ...
          */
          var ssh = go.SSH,
              goDiv = go.node,
              sshIDPanel = u.getNode('#'+prefix+'panel_ssh_ids'),
              uploadIDForm = u.createElement('form', {'name': prefix+'ssh_upload_id_form', 'class': '��ìsh_id_form'}),
          ...
          var closeDialog = go.Visual.dialog(gettext('Upload SSH Identity'), uploadIDForm, {'class': '��īrefsdialog', 'style': {'width': '20em'}});
          cancel.onclick = closeDialog;
      ...
      uploadCertificateForm: function(identity) {
          ...
          */
          var goDiv = go.node,
              closeDialog,
              sshIDPanel = u.getNode('#'+prefix+'panel_ssh_ids'),
              uploadCertForm = u.createElement('form', {'name': prefix+'ssh_upload_cert_form', 'class': '��ìsh_id_form ��Ếentered_text'}),
              certificateFile = u.createElement('input', {'type': 'file', 'id': 'ssh_upload_id_cert', 'name': prefix+'ssh_upload_id_cert'}),
              certificateFileLabel = u.createElement('label'),
              buttonContainer = u.createElement('div', {'class': '��Ếentered_buttons'}),
              submit = u.createElement('button', {'id': 'submit', 'type': 'submit', 'value': gettext('Submit'), 'class': '��Ê̄utton ��Ê̄lack'}),
          ...
          closeDialog = go.Visual.dialog(gettext('Upload X.509 Certificate'), uploadCertForm, {'class': '��īrefsdialog', 'style': {'width': '20em'}});
          cancel.onclick = closeDialog;
      ...
      enterPassphraseAction: function(settings) {
          ...
          */
          var goDiv = go.node,
              sshIDPanel = u.getNode('#'+prefix+'panel_ssh_ids'),
              passphraseForm = u.createElement('form', {'name': prefix+'ssh_passphrase_form', 'class': '��ìsh_id_form'}),
          ...
          var closeDialog = go.Visual.dialog(gettext('Passphrase for') + '"' + settings['name'] + '"', passphraseForm, {'class': '��īrefsdialog', 'style': {'width': '23em'}});
      ...
      createKHPanel: function() {
          ...
          */
          var existingPanel = u.getNode('#'+prefix+'panel_known_hosts'),
              sshPanel = u.createElement('div', {'id': 'panel_known_hosts', 'class': '��īanel ��ìectrans ��īanel_known_hosts'}),
              sshHeader = u.createElement('div', {'id': 'ssh_header', 'class': '��ìectrans'}),
              sshHRFix = u.createElement('hr', {'style': {'opacity': 0}}),
              sshKHTextArea = u.createElement('textarea', {'id': 'ssh_kh_textarea', 'rows': 30, 'cols': 100}),
              save = u.createElement('button', {'id': 'ssh_save', 'class': '��Ê̄utton ��Ê̄lack', 'type': 'submit'}),
              cancel = u.createElement('button', {'id': 'ssh_cancel', 'class': '��Ê̄utton ��Ê̄lack'}),
